    ...
    <div id="aboutMe" className="container py-5 aboutMe">
      <div className="row">
        ...
        <div className="col-lg-6 col-xm-12">
          ...
          <p>
            I am passionate about coding and I love to learn different
            technologies especially web UI development. My expertise and
            knowledge made me confirmable to flourish best in the area of web
            development and front-end development roles.
          </p>

          <p>
            In my free time, you can find me to do painting, playing badminton
            and at the beach. 
          </p>
        </div>
      </div>
